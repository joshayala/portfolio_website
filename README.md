...
Project has been revised to include new ongoing projects and remove other smaller projects that can be found on Github. Project also now includes Tailwind and has replaced removed older CSS methods.
